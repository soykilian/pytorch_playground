...
for epoch in n_epochs:
    ...
    start = time.time()
    train_loss, val_loss = Train(train_loader, val_loader, lr_model2, l1_loss, optimizerSDG, epoch)
    ...
    start = time.time()
    train_loss, val_loss = Train(train_loader, val_loader, lr_model, l1_loss, optimizerAdam, epoch)
